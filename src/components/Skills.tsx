...
const techStack: Item[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
        <path d="M18.406 19.28c-.336.552-.944.88-1.6.88-.432 0-.864-.16-1.184-.48L9.6 13.648v5.632c0 .88-.72 1.6-1.6 1.6S6.4 20.16 6.4 19.28V4.72c0-.88.72-1.6 1.6-1.6.656 0 1.264.328 1.6.88l6.022 6.032V4.72c0-.88.72-1.6 1.6-1.6s1.6.72 1.6 1.6v14.56c0 .304-.08.608-.24.88z" />
      </svg>
    ),
  },
  {
...
function Chip({ tech }: { tech: Item }) {
  return (
    <div
      ...
      `}
    >
      <span className="transition-transform duration-200">{tech.icon}</span>
      <span className="text-sm font-medium text-foreground whitespace-nowrap">
        {tech.name}
      </span>
      <span className="pointer-events-none absolute inset-0 opacity-0 hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-transparent via-white/5 to-transparent" />
    </div>
  );
}
...
function Row({
  ...
  return (
    <div className="mb-10">
      <h3 className="text-lg font-semibold mb-3 text-center text-muted-foreground">
        {title}
      </h3>
      ...
      <div className="hidden md:block overflow-hidden">
        <div
          className={`flex gap-4 w-max py-2 marquee ${
  ...
  return (
    <section id="skills" className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <Row title="Web Development" items={techStack} direction="left" />
        <Row
